  ...
  return (
    <section className="">
      <div
        ...
        className=" bg-no-repeat  bg-blend-overlay  bg-cover lg:h-[70vh] h-[30vh]   flex items-center lg:bg-cover bg-center"
      >
      ...
      <div className="customWidth">
        <section className=" my-10">
          ...
          <p className="text-center text-d1">
            Our mission at BikeBari is simple: to provide premium bikes, gear,
            and services at an affordable price while maintaining the highest
            level of customer satisfaction. We aim to foster a love for cycling
            and build lasting relationships with our customers.sdfsdfsdfsdfsdfs
          </p>
        </section>
